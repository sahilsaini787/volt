        ...
        currentPath.startsWith("/article") ? null : (
          ...
          >
            <svg
              ...
              className={`absolute h-[1.2rem] w-[1.2rem] rotate-90 scale-0 transition-all ${layoutStyle === "grid" ? styles.fade_in : styles.fade_out}`}
            >
            ...
            <svg
              ...
              strokeLinecap="round"
              strokeLinejoin="round"
              className={`h-[1.2rem] w-[1.2rem] transition-all -rotate-90 scale-0  ${layoutStyle === "list" ? styles.fade_in : styles.fade_out} `}
            >
              <rect width="7" height="7" x="3" y="3" rx="1"></rect>
              <rect width="7" height="7" x="3" y="14" rx="1"></rect>
              <path d="M14 4h7"></path>
      ...
      <div className={styles.switchThemeBtnContainer}>
        <button className={styles.switchThemeBtn} onClick={handleThemeChange}>
          <svg
            ...
            strokeLinecap="round"
            strokeLinejoin="round"
            className={`h-[1.2rem] w-[1.2rem] rotate-0 scale-100 transition-all dark:-rotate-90 dark:scale-0 ${themeMode === "light" ? styles.fade_in : styles.fade_out}`}
          >
          ...
          <svg
            ...
            strokeLinecap="round"
            strokeLinejoin="round"
            className={`absolute h-[1.2rem] w-[1.2rem] rotate-90 scale-0 transition-all dark:rotate-0 dark:scale-100 ${themeMode === "dark" ? styles.fade_in : styles.fade_out}`}
          >
